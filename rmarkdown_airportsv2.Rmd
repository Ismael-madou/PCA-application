...
Ce barplot des profils colonnes indique la répartition de chaque type d’aéroport en fonction du pays.

On remarque que les États Unis possedent un nombre élevé de tous les types d'aéroports mis à part au niveau de "large_airport" et "medium_airport" où la Chine (le pays marqué en orange) domine. 

Par ailleurs, nous notons également que le Canada (en jeune) possede plusieurs hydravions ("seaplane_base"). 
